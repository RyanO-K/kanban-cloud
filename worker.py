...
from app.prompt import build_agent_prompt, parse_question
    ...
    while not stop_event.is_set():
        try:
            ...
            if work:
                ...
                # marker (e.g. echoed back from a crashed prior attempt).
                question = parse_question(comment) if ok else None
                if question:
